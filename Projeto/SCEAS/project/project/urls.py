...
schema_view = get_schema_view(
    openapi.Info(
        title="SCEAS - API",
        default_version='v1',
        description="Sistema de Controle de Entrada de Alunos e Servidores",
        terms_of_service="https://www.google.com/policies/terms/",
        contact=openapi.Contact(email="joaocvgalescky@gmail.com"),
...
urlpatterns = [
    ...
    path('', include('api.urls')),  # URLs da API
